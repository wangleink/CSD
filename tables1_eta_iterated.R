...
tpqr1_eta=rep(0,Run)
tpqr2_eta=rep(0,Run)
tpqrave1_eta=rep(0,Run)
tpqrave2_eta=rep(0,Run)
...
beta_pqr_1_eta=matrix(0,(d*Run),1)
beta_pqr_2_eta=matrix(0,(d*Run),1)
beta_pqr_3_eta=matrix(0,(d*Run),1)
beta_pqr_ave_eta=matrix(0,(d*Run),1)
...
for (r in 1:Run){
  ...
  beta_hat4_1=optim(beta_hat_4,f_pqr,method = "BFGS")$par
  beta_pqr_1_eta[((r-1)*d+1):(r*d),1]=beta_hat4_1
  t2_csl_eta=proc.time()
  #########################################################################################################################
  eta_hat_1=eta_hat
  res1=matrix(0,n,1)
  L_N=0
  ...
  beta_hat4_1=optim(beta_hat4_1,f_pqr,method = "BFGS")$par
  beta_pqr_2_eta[((r-1)*d+1):(r*d),1]=beta_hat4_1
  t3_csl_eta=proc.time()
  #####################################################################################################csl_all方法
  t1_gel_eta=proc.time()
  beta_hat_9=beta_hat
  ...
  beta_hat_9=apply(beta_hat9,1,mean)
  beta_pqr_3_eta[((r-1)*d+1):(r*d),1]=beta_hat_9
  t2_gel_eta=proc.time()
  ###########################################################################################################
  res1=matrix(0,n,1)
  L_N=0
  for (m in 1:M){
  ...
  beta_hat_9=apply(beta_hat9,1,mean)
  beta_pqr_ave_eta[((r-1)*d+1):(r*d),1]=beta_hat_9
  t3_gel_eta=proc.time()
  
  
  tpqr1[r]=(t2_csl-t1_csl)[3]
  tpqr2[r]=(t3_csl-t2_csl)[3]
  tpqrave1[r]=(t2_gel-t1_gel)[3]
  tpqrave2[r]=(t3_gel-t2_gel)[3]
  tpqr1_eta[r]=(t2_csl_eta-t1_csl_eta)[3]
  tpqr2_eta[r]=(t3_csl_eta-t2_csl_eta)[3]
  tpqrave1_eta[r]=(t2_gel_eta-t1_gel_eta)[3]
  tpqrave2_eta[r]=(t3_gel_eta-t2_gel_eta)[3]
...
msepqr1_all_eta=rep(0,Run)
madpqr1_all_eta=rep(0,Run)
msepqr2_all_eta=rep(0,Run)
madpqr2_all_eta=rep(0,Run)
msepqr3_all_eta=rep(0,Run)
madpqr3_all_eta=rep(0,Run)

msepqrave_all_eta=rep(0,Run)
madpqrave_all_eta=rep(0,Run)
...
for (r in 1:Run){
  ...
  msepqr1_all_eta[r]=sum( (beta_pqr_1_eta[((r-1)*d+1):(r*d),1]-beta0)^2 )
  madpqr1_all_eta[r]=sum( abs(beta_pqr_1_eta[((r-1)*d+1):(r*d),1]-beta0) )
  msepqr2_all_eta[r]=sum( (beta_pqr_2_eta[((r-1)*d+1):(r*d),1]-beta0)^2 )
  madpqr2_all_eta[r]=sum( abs(beta_pqr_2_eta[((r-1)*d+1):(r*d),1]-beta0) )
  msepqr3_all_eta[r]=sum( (beta_pqr_3_eta[((r-1)*d+1):(r*d),1]-beta0)^2 )
  madpqr3_all_eta[r]=sum( abs(beta_pqr_3_eta[((r-1)*d+1):(r*d),1]-beta0) )
  
  msepqrave_all_eta[r]=sum( (beta_pqr_ave_eta[((r-1)*d+1):(r*d),1]-beta0)^2 )
  madpqrave_all_eta[r]=sum( abs(beta_pqr_ave_eta[((r-1)*d+1):(r*d),1]-beta0) )
...
msepqr1_eta=mean(msepqr1_all_eta)
madpqr1_eta=mean(madpqr1_all_eta)
msepqr2_eta=mean(msepqr2_all_eta)
madpqr2_eta=mean(madpqr2_all_eta)
msepqr3_eta=mean(msepqr3_all_eta)
madpqr3_eta=mean(madpqr3_all_eta)

msepqrave_eta=mean(msepqrave_all_eta)
madpqrave_eta=mean(madpqrave_all_eta)
